...
<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div v-for="(address,index) in addressInfo" :key="address.id" class="address clearFix">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul v-for="(order,index) in orderInfo.detailArrayList" :key="order.skuId" class="list clearFix">
          <li>
      ...
      <div class="bbs">
        <h5>买家留言：</h5>
        <textarea v-model="msg" class="remarks-cont" placeholder="建议留言前先与商家沟通确认"></textarea>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:<span>{{ userDefaultAddress.userAddress }}</span>
